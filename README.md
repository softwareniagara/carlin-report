...
~~~sh
# getting the code
git clone git@github.com:nko4/software-niagara.git && cd ./software-niagara/

# developing
npm install
npm start

# deploying (to http://software-niagara.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@software-niagara.2013.nodeknockout.com
ssh root@software-niagara.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@software-niagara.2013.nodeknockout.com
ssh -i ./id_deploy root@software-niagara.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/software-niagara" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
